...
class ConfigManager{
	...
	public function __construct($plugin){
        ...
        $this->webhook = new Config($plugin->getDataFolder() . "discordwebhook.yml", Config::YAML,[

            "DiscordWebhook" => "https://discord.com/api/webhooks/xxxxxxxxxxxxxxxx/xxxxxxxxxxxxxxxxxxxxxxxxxxx"
        ]);
		$this->plugin = $plugin;
		self::$instance = $this;
	...
	public function getWebhookURL() {
	    ...
	    return $this->webhook->get("DiscordWebhook");
